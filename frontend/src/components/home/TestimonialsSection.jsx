...
const testimonials = [
  {
    ...
    review: 'GPS Fleet Pro transformed our operations. We reduced fuel costs by 28% in the first 3 months and eliminated unauthorized vehicle use entirely.',
    rating: 5,
    avatar: 'RK',
  ...
  },
  {
    ...
    review: "Parents love the live bus tracking feature. We've received zero complaints about bus delays since installing GPS Fleet Pro across our 45 school buses.",
    rating: 5,
    avatar: 'AP',
